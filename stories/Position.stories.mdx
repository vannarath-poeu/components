...
import {Box, Heading, BorderBox, Relative, Absolute, Fixed, Sticky} from '../src'
import Docs from '../docs/content/Position.mdx'

<Meta title='Position' component={Relative}/>

<Story name="Relative + Absolute">
  <Box p={2} mb={200}>
